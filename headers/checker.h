...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/08/16 21:54:46 by mberengu          #+#    #+#             */
/*   Updated: 2021/08/16 21:54:46 by mberengu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		stack_min_max(t_list **params_receiver, t_list **lst1,
				t_pos *pos);
...
void		move_it(t_list **params_receiver, t_list **lst2, int act,
				t_list **tmp);
void		i_like_to_move_it(t_list **params_receiver, t_list **lst2,
				int act);
void		actions_apply_check(t_list **params, t_list **lst2,
				t_list **actions);
/*---------------------------------------------------------------------------*/
void		mvt_review(t_list **actions);
void		w_error(void);
